...
public class LoginFiter extends ZuulFilter{
    ...
    private String LOGIN_URL = "/nfsy-user/user/login";
    private String SEND_MAIL = "/nfsy-user/user/sendMail";
    private String REGISTRY = "/nfsy-user/user/registry";
